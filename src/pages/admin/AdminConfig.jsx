    ...
    <div className="admin-section">
      ...
      <div className="config-grid">
        ...
        <div className="config-block">
          ...
          <div className="field">
            <label>URL complète du site (utilisée pour les redirections de paiement)</label>
            <input
              className="input"
              name="site_url"
            ...
            />
            <p className="field-hint">À mettre à jour si vous changez de nom de domaine, sinon les clients seront mal redirigés après un paiement par carte.</p>
          </div>
        </div>
        ...
        <div className="config-block">
          ...
          <div className="field field-row">
            <input
              type="checkbox"
              id="ubereats_enabled"
              name="ubereats_enabled"
              checked={config.ubereats_enabled ?? false}
              onChange={handleChange}
            />
            <label htmlFor="ubereats_enabled" className="field-row-label">
              Afficher un bouton "Commander sur Uber Eats" sur le site
            </label>
          </div>
          {config.ubereats_enabled && (
            <div className="field">
              <label>Lien vers votre page Uber Eats</label>
              <input
                className="input"
                name="ubereats_url"
                value={config.ubereats_url || ''}
                onChange={handleChange}
